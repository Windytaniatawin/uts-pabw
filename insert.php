...
<div class="jumbotron login-form">
  ...
  if(isset($_POST['submit'])){
      ...
      $query = "INSERT INTO `korona` ( `kabkota`, `positif`, `meninggal`) VALUES ( '$kabkota', '$positif', '$meninggal');";
      $tambah = $koneksi->prepare($query);
      $tambah->execute();
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" id="positif" name="positif">
  </div>
  <div class="form-group">
